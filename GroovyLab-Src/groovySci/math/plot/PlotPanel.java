...
import groovySci.math.plot.canvas.Plot2DCanvas;
import groovySci.math.plot.canvas.PlotCanvas;
import groovySci.math.plot.components.LegendPanel;
import groovySci.math.plot.components.PlotToolBar;
import groovySci.math.plot.plotObjects.Axis;
import groovySci.math.plot.plotObjects.Plotable;
import groovySci.math.plot.plots.Plot;
   ...
   /*   these methods allow the handling of axis by retrieving first a PlotPanel reference.
    t = inc(0, 0.01, 20);
        ...
        public void xlabel(String xLabelStr) {
            setAxisLabel(groovySci.math.plot.PlotPanel.xAxisId, xLabelStr);
        }
        
        public void ylabel(String yLabelStr) {
            setAxisLabel(groovySci.math.plot.PlotPanel.yAxisId, yLabelStr);
        }
        
        public void zlabel(String zLabelStr) {
            if (this instanceof  Plot3DPanel) {
               setAxisLabel(groovySci.math.plot.PlotPanel.zAxisId, zLabelStr);
            }
        }
