...
public class gLab extends JFrame implements WindowListener, ActionListener
{
    ...
    // applications that can start from within
        ...
        public JMenuItem controlTimedInterruptJMenuItem;
...
public void redirectConsole()  {
        ...
        if (cudaPath != null && GlobalValues.useCUDAprop.equalsIgnoreCase("true"))   // CUDA is installed
        {
            NativeLibsObj.cudaObj = new KernelOps();
            NativeLibsObj.cudaSigObj = new CUDASig.CUDASig();
            GlobalValues.useCUDAflag = true;
            GlobalValues.useCUDAprop = "true";
        }
        else
        {
            GlobalValues.useCUDAflag = false;
            GlobalValues.useCUDAprop = "false";
        }
	...
	try {
        ...
        if (GlobalValues.useCUDAflag) {  // use CUDA is enabled
         if (NativeLibsObj.cudaObj != null) {  // CUDA inited correctly
            ...
            if (GlobalValues.GroovyShell != null) {
           GlobalValues.GroovyShell.evaluate(" groovySci.math.array.Matrix.metaClass.multiply = {  \n"+
...
GlobalValues.myGEdit = new gLabEditor("Untitled", true);
  ...
  if (explorerPanel != null)   {
     ...
     public void run() {  // run in  */
        ...
        gExec.gui.WatchClasses  watchClassesOfGroovySci = new gExec.gui.WatchClasses();
         ...
         watchClassesOfGroovySci.displayClassesAndMethodsAsString(groovySciClasses, "groovySci ", filterString,  gExec.gui.WatchClasses.watchXLoc+k*50, gExec.gui.WatchClasses.watchYLoc+k*50);
                ...
                GroovySciPlottingRoutinesMenuItemWithKeyword.addActionListener((ActionEvent e) -> {
        ...
        gExec.gui.WatchClasses  watchClassesOfOregonDSP = new gExec.gui.WatchClasses();
         ...
         watchClassesOfOregonDSP.displayClassesAndMethodsAsString( oregonDSPClasses, "com.oregondsp", filterString, gExec.gui.WatchClasses.watchXLoc+k*50, gExec.gui.WatchClasses.watchYLoc+k*50);
                ...
                coltRoutinesMenuItemWithKeyword.addActionListener((ActionEvent e) -> {
                 ...
                 JMenuItem  cudaDeviceInfoMenuItem  = new JMenuItem("Display CUDA Configuration");
     ...
     cudaHelpFrame.setSize(500, 400);
     cudaHelpFrame.pack();
     cudaHelpFrame.setVisible(true);
                    }
                });
        JMenu cudaMenu = new JMenu("CUDA");
        cudaMenu.add(cudaDeviceInfoMenuItem);
        final JMenuItem controlCUDAJMenuItem = new JMenuItem("Toggle default use of CUDA. Applies after restart. - Current state is  "+GlobalValues.useCUDAflag);
                 controlCUDAJMenuItem.setFont(GlobalValues.uifont);
                 controlCUDAJMenuItem.setToolTipText("Controls default reprogramming of operations to use CUDA. Warning: precision loss can occur.");
                 controlCUDAJMenuItem.addActionListener((ActionEvent e) -> {
                     ...
                     if (GlobalValues.useCUDAflag == true) {
                         ...
                         controlCUDAJMenuItem.setText("CUDA enable state is now: "+GlobalValues.useCUDAprop);
                     }
                });
        ...
        appearanceMenu.setToolTipText("Appearance related settings (e.g. fonts, etc. )");
                ...
                controlIndyJMenuItem.addActionListener((ActionEvent e) -> {
                    GlobalValues.GroovyShell = null;
                ...
                controlTimedInterruptJMenuItem.addActionListener((ActionEvent e) -> {
                     ...
                     GlobalValues.timedInterruptScriptingOn = !GlobalValues.timedInterruptScriptingOn;
                 ...
                 setTimedInterruptValueJMenuItem.addActionListener((ActionEvent e) -> {
                     GlobalValues.GroovyShell = null;
                     String newTimeout = javax.swing.JOptionPane.showInputDialog(null, "Set the time out value ", GlobalValues.timedInterruptValue);
                     GlobalValues.timedInterruptValue = Long.parseLong(newTimeout);
                ...
                controlDecimalsToDoublesJMenuItem.addActionListener((ActionEvent e) -> {
                    GlobalValues.GroovyShell = null;
                ...
                controlDefaultlmportsJMenuItem.addActionListener((ActionEvent e) -> {
               ...
               decreaseRSyntaxFontMenuItem.addActionListener((ActionEvent e) -> {
                ...
                resetGroovyShellJMenuItem.addActionListener((ActionEvent e) -> {
                    GlobalValues.GroovyShell.resetLoadedClasses();
              ...
              //  configAlphaParamJMenuItem = new JMenuItem(new configAlphaAction());
               // configAlphaParamJMenuItem.setFont(GlobalValues.uifont);
                ...
                confMenuGroovy.add(controlTimedInterruptJMenuItem);
                confMenuGroovy.add(setTimedInterruptValueJMenuItem);
...
//GroovySciExamplesHelpJMenuItem.setIcon(new ImageIcon(groovyImage));
        ...
        examplesMenu.add(GroovySciWaveletExamplesHelpJMenuItem);
                ...
                toolboxesHelpJMenuItem.addActionListener((ActionEvent e) -> {
