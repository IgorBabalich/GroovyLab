...
{  
    static public   String  dateOfBuild =  "14-March-2017";       // tracks the date of build    
...
public static void prepareImports() {
 if (globallmportCustomizer == null) {
    ...
    // these platforms support by default JavaFX ith JDK8
    if (GlobalValues.hostIsWin64 || GlobalValues.hostIsLinux64  || GlobalValues.hostIsMac) {
          // add additional imports for Windows and Linux
    globallmportCustomizer.addStaticStars(
            "groovySci.math.plot.JavaFX.javaFXPlotLine",
            "groovySci.math.plot.JavaFX.javaFXPlotScatter",
            "groovySci.math.plot.JavaFX.javaFXPlotLine",
            "groovySci.math.plot.JavaFX.javaFXPlotBar",
            "groovySci.math.plot.JavaFX.javaFXPlotPie",
